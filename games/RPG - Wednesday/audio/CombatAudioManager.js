...
export class CombatAudioManager {
    ...
    isDebuff(effectType) {
        return ['stun', 'weaken', 'mark', 'restrain', 'poison', 'blind', 'slow', 'vulnerable'].includes(effectType);
    }

    isBuff(effectType) {
        return ['damage_boost', 'shield', 'dodge', 'concealment', 'haste', 'heal', 'accuracy_boost'].includes(effectType);
    }
}
